...
const Header = () => {
    const navLinks = <>
        ...
        <li className="text-white"><NavLink to="/Politics" >Politics</NavLink></li>
        <li className="text-white"><NavLink to="/Sports" >Sports</NavLink></li>
        <li className="text-white"><NavLink to="/Country" >Country</NavLink></li>
        <li className="text-white"><NavLink to="/Entertainment" >Entertainment</NavLink></li>
        <li className="text-white"><NavLink to="/Business" >Business</NavLink></li>
    </>
    return (
